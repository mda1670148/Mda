Contributing to Aratriton
============================

The Aratriton project operates an open contributor model where anyone is
...
The following applies to code changes to the Aratriton project, and is not to be
confused with overall Aratriton Network Protocol consensus changes.

Whether a pull request is merged into Aratriton rests with the project merge
...
Patches that change Aratriton consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aratriton consensus, it must have been
...
The project leader is the release manager for each Aratriton release.
