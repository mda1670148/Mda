...
In order to support loading of multiple wallets in aratriton-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aratriton.cpp.
...
Changes to aratriton.cpp
----------------------
aratriton.cpp is the entry point into aratriton-qt, and as such, will require some minor modifications to provide hooks for
