...
#   c) node1 mines 32 blocks, so now node 0 has 60001ara, node 1 has 4250ara, node2 has none.
#   d) node0 sends 601 ara to node2, in two transactions (301 ara, then 300 ara).
