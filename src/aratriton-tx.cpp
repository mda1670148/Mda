...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Aratriton aratriton-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  aratriton-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aratriton transaction") + "\n" +
                               "  aratriton-tx [options] -create [commands]   " + _("Create hex-encoded aratriton transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded aratriton transaction
