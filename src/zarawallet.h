...
#ifndef Aratriton_ZARAWALLET_H
#define Aratriton_ZARAWALLET_H
...
public:
    CzARAWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZARA(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZARA(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //Aratriton_ZARAWALLET_H
