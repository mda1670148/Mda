...
/** Utility functions used by the Aratriton Qt UI.
 */
namespace GUIUtil
{
...
// Render Aratriton addresses in monospace font
...
// Parse "aratriton:" URI into recipient object, return true on successful parsing
