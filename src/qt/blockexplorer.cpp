...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::ARA, nValue);
...
{
    std::string genesisblockhash = "00000fc630a7ded957563e9bd478de331a31c410091c4aa9b70525a24ba5958e";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (aratriton.conf).");
            QMessageBox::warning(this, "Aratriton Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#211d73;}\n a, span { font-family: monospace; }\n span.addr {color:#211d73; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #211d73;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#211d73;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#211d73;}\n";
