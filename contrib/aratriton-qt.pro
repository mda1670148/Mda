...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/aratriton-cli.cpp \
           src/aratriton-tx.cpp \
           src/aratriton.cpp \
           src/db.cpp \
           ...
           src/qt/aratriton.cpp \
           src/qt/aratritonstrings.cpp \
...
RESOURCES += src/qt/aratriton.qrc src/qt/aratriton_locale.qrc

TRANSLATIONS += src/qt/locale/aratriton_bg.ts \
                src/qt/locale/aratriton_de.ts \
                src/qt/locale/aratriton_en.ts \
                src/qt/locale/aratriton_es.ts \
                src/qt/locale/aratriton_fi.ts \
                src/qt/locale/aratriton_fr.ts \
                src/qt/locale/aratriton_it.ts \
                src/qt/locale/aratriton_ja.ts \
                src/qt/locale/aratriton_pl.ts \
                src/qt/locale/aratriton_pt.ts \
                src/qt/locale/aratriton_ru.ts \
                src/qt/locale/aratriton_sk.ts \
                src/qt/locale/aratriton_sv.ts \
                src/qt/locale/aratriton_vi.ts \
                src/qt/locale/aratriton_zh_CN.ts \
                src/qt/locale/aratriton_zh_TW.ts
